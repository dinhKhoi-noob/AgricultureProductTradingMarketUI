...
const BuyingRequestForBuyingRequestDetails = () => {
    const {
        currentSubrequest,
        ...
        <>
            ...
            <Grid container padding={6} justifyContent="space-between">
                <Grid item md={3.8} sm={12}>
                    ...
                    <Box display="flex" justifyContent="space-between" mt={2} mb={2}>
                        <Typography fontWeight="bold">Ngày nhận hàng {"(trước)"}:</Typography>&nbsp;
                        <Typography>
...
export default BuyingRequestForBuyingRequestDetails;
